...
export const userWord = pgTable(
	"user_word",
	{
		...
		notes: text("notes"),
		customPartOfSpeech: text("custom_part_of_speech"),
		customDefinition: text("custom_definition"),
		customExampleSentence: text("custom_example_sentence"),
		customTranslation: text("custom_translation"),
...
export const userPhrase = pgTable(
	"user_phrase",
	{
		...
		source: text("source").notNull(),
		notes: text("notes"),
		customMeaning: text("custom_meaning"),
		customExampleUsage: text("custom_example_usage"),
		customTranslation: text("custom_translation"),
		customLiteralTranslation: text("custom_literal_translation"),
		repetition: integer("repetition").notNull().default(0),
		intervalDays: integer("interval_days").notNull().default(0),
		easeFactor: real("ease_factor").notNull().default(2.5),
		lapses: integer("lapses").notNull().default(0),
